                ...
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#data_konsumen" role="tab">
                            ...
                            <div class="text-small description d-none d-md-block">Edit Data Konsumen</div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#data_motor" role="tab">
                            <div class="mb-1 title d-none d-sm-block">Data Motor</div>
                            <div class="text-small description d-none d-md-block">Edit Data Motor</div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#harga" role="tab">
                            <div class="mb-1 title d-none d-sm-block">Harga</div>
                            <div class="text-small description d-none d-md-block">Edit Harga</div>
                        </a>
                    </li>
            ...
            <div class="card-body h-auto">
                        ...
                        <form action="/pembelian/{{ $beli->unique }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-floating col-md-12">
                                    ...
                                    <input type="hidden" name="penjual" value="{{ $consumer->penjual }}">
                                </div>
                                <div id="data_konsumen" class="tab-pane" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" name="nik" id="nik" class="form-control @error('nik')is-invalid @enderror" value="{{ old('nik', $consumer->nik) }}" placeholder="Masukan NIK">
                                            @error('nik')
                                        ...
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" name="nama" id="nama" class="form-control @error('nama')is-invalid @enderror" value="{{ old('nama', $consumer->nama) }}" placeholder="Masukan Nama Lengkap">
                                            @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-floating mb-3 col-md-6">
                                            <input type="text" class="form-control @error('no_telepon')is-invalid @enderror" name="no_telepon" id="no_telepon" value="{{ old('no_telepon', $consumer->no_telepon) }}" placeholder="Masukan Nomor Telepon">
                                            @error('no_telepon')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-floating mb-3 col-md-6">
                                            <textarea class="form-control @error('alamat')is-invalid @enderror" rows="2" name="alamat" id="alamat" placeholder="Masukan Alamat">{{ old('alamat', $consumer->alamat) }}</textarea>
                                            @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="form-floating mb-3 col-md-6">
                                    <input type="text" name="nama_kang" id="nama_kang" class="form-control @error('nama_kang')is-invalid @enderror" value="{{ old('nama_kang', $consumer->nama) }}" placeholder="Masukan Nama Petugas">
                                    @error('nama_kang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-floating mb-3 col-md-6">
                                    <input type="text" name="dealer" id="dealer" class="form-control @error('dealer')is-invalid @enderror" value="{{ old('dealer', $consumer->dealer) }}" placeholder="Masukan Nama Dealer">
                                    @error('dealer')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="tab-pane fade" id="data_motor" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="merek" id="merek" class="form-control @error('merek')is-invalid @enderror" value="{{ old('merek', $motor->merek) }}" placeholder="Masukan Merk">
                            @error('merek')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="type" id="type" class="form-control @error('type')is-invalid @enderror" value="{{ old('type', $motor->type) }}" placeholder="Masukan Tipe">
                            @error('type')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="tahun_pembuatan" class="form-control @error('tahun_pembuatan') is-invalid @enderror" placeholder="Masukan Tahun Pembuatan" value="{{ old('tahun_pembuatan', $motor->tahun_pembuatan) }}">
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="warna" id="warna" class="form-control @error('warna')is-invalid @enderror" value="{{ old('warna', $motor->warna) }}" placeholder="Masukan Warna">
                            @error('warna')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="no_rangka" id="no_rangka" class="form-control @error('no_rangka')is-invalid @enderror" value="{{ old('no_rangka', $motor->no_rangka) }}" placeholder="Masukan No Rangka">
                            @error('no_rangka')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="no_mesin" id="no_mesin" class="form-control @error('no_mesin')is-invalid @enderror" value="{{ old('no_mesin', $motor->no_mesin) }}" placeholder="Masukan No Rangka">
                            @error('no_mesin')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="no_polisi" id="no_polisi_edit" class="form-control @error('no_polisi')is-invalid @enderror" value="{{ old('no_polisi', $motor->no_polisi) }}" placeholder="Masukan No Polisi">
                            @error('no_polisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="bpkb" id="bpkb" class="form-control @error('bpkb')is-invalid @enderror" value="{{ old('bpkb', $motor->bpkb) }}" placeholder="Masukan BPKB">
                            @error('bpkb')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" name="nama_bpkb" id="nama_bpkb" class="form-control @error('nama_bpkb')is-invalid @enderror" value="{{ old('nama_bpkb', $motor->nama_bpkb) }}" placeholder="Masukan BPKB">
                            @error('nama_bpkb')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" class="form-control @error('alamat_bpkb')is-invalid @enderror" value="{{ old('alamat_bpkb', $motor->alamat_bpkb) }}" placeholder="Masukan Masa Berlaku" name="alamat_bpkb" id="alamat_bpkb">
                            @error('alamat_bpkb')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                            <label class="text-label" for="alamat_bpkb">&nbsp;&nbsp;Alamat BPKB<span class="text-danger"> *</label></span>
                        </div>
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" class="date-picker form-control @error('berlaku_sampai')is-invalid @enderror" value="{{ old('berlaku_sampai', $motor->berlaku_sampai) }}" placeholder="Masukan Masa Berlaku" name="berlaku_sampai" id="berlaku_sampai">
                        ...
                        <div class="form-floating mb-3 col-md-6">
                            <input type="text" class="date-picker form-control @error('perpanjang_stnk')is-invalid @enderror" value="{{ old('perpanjang_stnk', $motor->perpanjang_stnk) }}" placeholder="Masukan Perpanjang STNK" name="perpanjang_stnk" id="perpanjang_stnk">
                ...
                <div class="tab-pane fade" id="harga" role="tabpanel">
                    ...
                    <div class="row">
                        <div class="form-floating mb-3 col-6">
                            <input type="text" class="form-control money @error('harga_beli')is-invalid @enderror" value="{{ old('harga_beli', $beli->harga_beli) }}" placeholder="Masukan Harga Beli" name="harga_beli" id="harga_beli">
                        ...
                        <div class="form-floating mb-3 col-6">
                            <input type="text" class="date-picker form-control @error('tanggal_beli')is-invalid @enderror" value="{{ old('tanggal_beli', $beli->tanggal_beli) }}" placeholder="Masukan Tanggal Pembelian" name="tanggal_beli" id="tanggal_beli">
                ...
                <div class="tab-pane fade" id="basicLast" role="tabpanel">
                    <div class="text-center mt-5">
                        ...
                        <p class="card-text text-alternate mb-4">Silahkan klik button dibawah untuk mengedit</p>
